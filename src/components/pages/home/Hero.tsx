    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          >
            <g clipPath="url(#clip0_236_1056)">
              <path
                ...
                fill="url(#paint0_linear_236_1056)"
              />
            </g>
            <defs>
              <linearGradient
                id="paint0_linear_236_1056"
                x1="14"
                y1="26"
                x2="179"
                y2="179.5"
        ...
        >
          ...
          >
            <path
              d="M100.106 0L115 54.1591L158.884 19.0983L139.1 71.6687L195.211 69.0983L148.306 100L195.211 130.902L139.1 128.331L158.884 180.902L115 145.841L100.106 200L85.211 145.841L41.3271 180.902L61.111 128.331L5 130.902L51.9057 100L5 69.0983L61.111 71.6687L41.3271 19.0983L85.211 54.1591L100.106 0Z"
              fill="url(#paint0_linear_103_4)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_103_4"
                x1="31.1541"
                y1="19"
                x2="153.991"
                y2="168.516"
          ...
          >
            <g clipPath="url(#clip0_236_1056_med)">
              <path
                ...
                clipRule="evenodd"
                d="M100 0C72.3858 0 50 22.3858 50 50C22.3858 50 2.18557e-06 72.3858 0 100C0 127.614 22.3858 150 50 150C50 177.614 72.3858 200 100 200C127.614 200 150 177.614 150 150C177.614 150 200 127.614 200 100C200 72.3858 177.614 50 150 50C150 22.3858 127.614 0 100 0ZM140.306 59.6939C140.306 37.4334 122.26 19.3878 100 19.3878C77.7395 19.3878 59.6939 37.4334 59.6939 59.6939C37.4334 59.6939 19.3878 77.7395 19.3878 100C19.3878 122.26 37.4334 140.306 59.6939 140.306C59.6939 162.567 77.7395 180.612 100 180.612C122.26 180.612 140.306 162.567 140.306 140.306C162.567 140.306 180.612 122.26 180.612 100C180.612 77.7395 162.567 59.6939 140.306 59.6939ZM69.3878 69.3878C69.3878 52.4811 83.0933 38.7755 100 38.7755C116.907 38.7755 130.612 52.4811 130.612 69.3878C147.519 69.3878 161.224 83.0933 161.224 100C161.224 116.907 147.519 130.612 130.612 130.612C130.612 147.519 116.907 161.224 100 161.224C83.0933 161.224 69.3878 147.519 69.3878 130.612C52.4811 130.612 38.7755 116.907 38.7755 100C38.7755 83.0933 52.4811 69.3877 69.3878 69.3878Z"
                fill="url(#paint0_linear_236_1056_med)"
              />
            </g>
            <defs>
              <linearGradient
                id="paint0_linear_236_1056_med"
                x1="14"
                y1="26"
                x2="179"
                y2="179.5"
      ...
      <div className="relative z-10 flex flex-col items-center gap-3 text-center max-w-4xl">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight leading-[0.9] font-allura">
            <span className="text-foreground">Dipesh </span>
        ...
        >
          <p className="text-base sm:text-lg md:text-xl text-foreground/60 leading-relaxed font-inter">
            ...
            and logic, crafting expansive websites that sing with beauty,
            respond to every need, and delight the user&apos;s senses.
          </p>
        </motion.div>
        ...
        >
          <Link href="/contact" passHref>
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-4 py-4 md:px-8 bg-primary-600 hover:bg-primary-700 text-white font-semibold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-inter hover:cursor-pointer"
            >
              Let&apos;s Work Together
            </motion.button>
          </Link>
          ...
          <Link href="/projects" passHref>
            <motion.button
              whileHover={{ scale: 1.02, y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="px-4 md:px-8 py-4 bg-transparent border-2 border-primary-300 text-primary-600 hover:bg-primary-50 dark:hover:bg-primary-900/20 font-semibold text-lg rounded-xl transition-all duration-300 font-inter hover:cursor-pointer"
            >
              View Portfolio
            </motion.button>
          </Link>
